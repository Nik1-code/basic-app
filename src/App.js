  ...
  return (
    <div className="App">
      ...
      <div>
        ...
        <p>
          Dont know how to play an instrument then no need to worry. We are here
          to teach you from basic to advance. You are just one click away from
          becoming the good player.
        </p>
      </div>
      <div>
        ...
        <p>
          ...
          remove ads and get some advance knowledge. Subscribe for free first 7
          days!
        </p>
      </div>
      <div>
